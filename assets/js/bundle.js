	...
	var Header = (function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      ...
	      if (session) {
	        conditionList = _react2['default'].createElement('ul', null);
	      } else {
	        conditionList = _react2['default'].createElement(
	          'ul',
	          null,
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'a',
	              { href: '/', className: _utils2['default'].topPath() == '' ? 'active' : '' },
	              '首页'
	            )
	          ),
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'a',
	              { href: '/signin', className: _utils2['default'].topPath() == 'signin' ? 'active' : '' },
	              '登录'
	            )
	          ),
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'a',
	              { href: '/signup', className: _utils2['default'].topPath() == 'signup' ? 'active' : '' },
	              '注册'
	            )
	          )
	        );
